...
from .base import (
    get_colors,
    _save_with_adjust,
    rotate_yticklabels, rotate_xticklabels,
)
...
def plot_contingency_mat(
    ...
    from .compute import wrapper_contingency_mat
    ...
    if arrange:
        ...
        from .compute import arrange_contingency_mat
...
def heatmap(df_hmap: pd.DataFrame,
    ...
    from .compute import order_contingency_mat
    if order_col:
